...
import { createExtra } from '@admin/services/extraService'

const { customToast } = useCustomToast()
const { toExtrasList } = useRedirects()
const { initialValues } = useExtra()
...
const onFormSubmit = async ({ valid, values, errors }) => {
    if (valid) {
        try {
            ...
            customToast.success('Extra created successfully!')
